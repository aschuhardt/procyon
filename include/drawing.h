...
procy_draw_op_t procy_create_draw_op_string_colored(
    ...
    procy_color_t background, const char *contents, size_t index, bool bold);

procy_draw_op_t procy_create_draw_op_char(short x, short y, short z, char c,
                                          bool bold);

procy_draw_op_t procy_create_draw_op_char_colored(short x, short y, short z,
                                                  procy_color_t color,
                                                  procy_color_t background,
                                                  char c, bool bold);
